...
torch::Tensor roi_align_forward_cpu(const torch::Tensor& input,
    ...
    auto total_size = num_rois * output_size * output_size * channels;
...
torch::Tensor roi_align_backward_cpu(const torch::Tensor& grad,
                                     const torch::Tensor& rois,
                                     const float spatial_scale,
    ...
    const int pooled_width = grad.size(3);
    const int pooled_height = grad.size(2);
